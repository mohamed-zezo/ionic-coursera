...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $localStorage, $ionicPlatform, $cordovaCamera, $cordovaImagePicker) {
    ...
    // Form data for the addFavorite modal
...
.controller('IndexController', ['$scope', 'leader', 'dish', 'promotion', 'menuFactory', 'promotionFactory', 'corporateFactory', 'baseURL',
    function($scope, leader, dish, promotion, menuFactory, promotionFactory, corporateFactory, baseURL) {
